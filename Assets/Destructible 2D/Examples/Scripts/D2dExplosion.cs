		...
		protected override void OnInspector()
		{
			...
			if (Any(t => t.Stamp == true))
			{
				BeginIndent();
                    ...
                    DrawDefault("StampAngle");
                    DrawDefault("StampNormal");
                EndIndent();
			}
...
namespace Destructible2D
{
	...
	public class D2dExplosion : MonoBehaviour
	{
        ...
        [Tooltip("If true, ignore Stamp Random Direction and stamp in the normal direction. If false and random dir is also false, stamp in stamp angle")]
        public bool StampNormal = true;

        [Tooltip("Angle for stamp")]
        public float StampAngle = 1.0f;
        ...
        public void triggerExplosion()
        {
            if (Stamp == true)
            {
                ...
                var finalAngle = StampRandomDirection == true ? Random.Range(-180.0f, 180.0f) : StampAngle;
                //Debug.Log("Stamp direction:" + finalAngle);
                D2dDestructible.StampAll(stampPosition, StampSize, finalAngle, StampTex, StampHardness, Mask);
            }
