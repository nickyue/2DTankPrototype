...
namespace Destructible2D
{
	...
	public partial class D2dDestructible : MonoBehaviour
	{
		...
		public bool TryLocalSplit(D2dRect splitRect)
		{
			...
			D2dFloodfill.FastFindLocal(alphaData, alphaWidth, alphaHeight, lapRect);
			...
			if (D2dFloodfill.BorderIslands.Count + D2dFloodfill.Islands.Count > 1)
			{
				...
				{
					var borderGroup = D2dSplitGroup.GetSplitGroup();

					for (var i = D2dFloodfill.BorderIslands.Count - 1; i >= 0; i--)
					{
						borderGroup.AddIsland(D2dFloodfill.BorderIslands[i]);
					}
